                ...
                <div className='row'>
                    ...
                    <div className='col-lg-4 col-md-4 col-sm-12'>
                        <div style={{ textAlign: "center" }}>
                            ...
                            <button disabled={buttonLoading.individual} className='btn btn-success mt-3' type="submit"
                                onClick={() => handleButtonClick('individual')}
                            >
                                {buttonLoading.individual ? 'Loading...' : 'Checkout'}
                            </button>
                        </div>
                    </div>
                    <div className='col-lg-4 col-md-4 col-sm-12'>
                        <div style={{ textAlign: "center" }}>
                            ...
                            <button disabled={buttonLoading.group} className='btn btn-success mt-3' type="submit"
                                onClick={() => handleButtonClick('group')}
                            >
                                {buttonLoading.group ? 'Loading...' : 'Checkout'}
                            </button>
                        </div>
                    </div>
                    <div className='col-lg-4 col-md-4 col-sm-12'>
                        <div style={{ textAlign: "center" }}>
                            ...
                            <button disabled={buttonLoading.business} className='btn btn-success mt-3' type="submit"
                                onClick={() => handleButtonClick('business')}
                            >
                                {buttonLoading.business ? 'Loading...' : 'Checkout'}
                            </button>
                        </div>
                    </div>
                </div>
